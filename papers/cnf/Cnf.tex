    ...
    \begin{description}
        ...
        \begin{center}
            \begin{tabular}{l|p{3px}|p{3px}|p{3px}|p{3px}|r}
                ...
                \multicolumn{1}{l||}{\multirow{2}{*}{C}} &\cellcolor{black} & \cellcolor{black} && \cellcolor{black} \\ \hhline{~|*{4}{-}}
                \multicolumn{1}{c||}{} &\cellcolor{black} & \cellcolor{black} & \cellcolor{black} & \cellcolor{black} & \multicolumn{1}{||r}{\multirow{2}{*}{D}} \\ \hhline{~|*{4}{-}}
                &\cellcolor{black} & \cellcolor{black} & \cellcolor{black} && \multicolumn{1}{||r}{} \\ \hhline{~|*{4}{-}}
                & \cellcolor{black} & \cellcolor{black} && \\ \cline{2-5} \noalign{\vskip\doublerulesep\vskip-\arrayrulewidth} \cline{3-4}
                \multicolumn{2}{c}{} & \multicolumn{2}{c} B \\
            \end{tabular}
        \end{center}
